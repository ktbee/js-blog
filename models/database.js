...
// tags table
var query = client.query('CREATE TABLE IF NOT EXISTS tags(id SERIAL PRIMARY KEY, tag VARCHAR(255))');

// tags - posts pivot table
var query = client.query('CREATE TABLE IF NOT EXISTS post_tag(id SERIAL PRIMARY KEY, post_id INT references posts(id), tag_id INT references tags(id))');
